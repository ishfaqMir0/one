...
.lp-nav-logo img { width:38px; height:38px; border-radius:10px; object-fit:contain; }
...
.lp-hero-bg {
  ...
  inset: 0;
  background:
    linear-gradient(160deg, rgba(5,46,22,.9) 0%, rgba(6,78,59,.84) 40%, rgba(4,120,87,.74) 70%, rgba(5,46,22,.88) 100%),
...
.lp-hero-logo img { width:88px; height:88px; border-radius:22px; object-fit:contain; display:block; }
...
.lp-hero-title .brand-dot  { color:rgba(255,255,255,.35); }
.lp-hero-title .brand-name { color:#fff; }
.lp-hero-punchline {
...
.lp-hero-punchline .hl { color:#6ee7b7; font-weight:900; }
.lp-hero-sub {
...
.lp-stat { flex:1; min-width:120px; text-align:center; padding:.5rem 1rem; border-right:1px solid rgba(255,255,255,.1); }
.lp-stat:last-child { border-right:none; }
.lp-stat-val { font-size:1.5rem; font-weight:900; color:#6ee7b7; line-height:1; }
.lp-stat-lbl { font-size:.67rem; font-weight:600; color:rgba(255,255,255,.55); text-transform:uppercase; letter-spacing:.1em; margin-top:.2rem; }
...
.lp-scroll-hint span { font-size:.65rem; font-weight:600; letter-spacing:.1em; text-transform:uppercase; color:rgba(255,255,255,.4); }
.lp-scroll-arrow {
  width:28px; height:28px; border:1.5px solid rgba(255,255,255,.3);
...
const TAB_PLANS: Record<string, { desc: string; plans: Plan[] }> = {
  ...
  business: {
    desc: 'For agri-tech companies, developers building on AppleKul, and farm management businesses.',
    plans: [
      {
        id: 'dev-basic',
        icon: '⚙️',
  ...
  cooperative: {
    desc: 'Purpose-built for Cooperative Agriculture (CA) stores, FPOs, and agricultural cooperatives.',
    plans: [
      {
        id: 'ca-starter',
        icon: '🏬',
...
const LandingPage: React.FC = () => {
  ...
  const getOrigPrice = (plan: Plan) =>
    billing === 'monthly' ? (plan.origMonthly ?? null) : (plan.origAnnual ?? null);
  const getSave = (plan: Plan) =>
    billing === 'annual' ? (plan.saveAnnual ?? null) : (plan.saveMonthly ?? null);
      ...
      <section className="lp-hero">
        ...
        <div className="lp-hero-content">
          ...
          <h1 className="lp-hero-title">
            <span className="brand-one">AppleKul</span>
        ...
        <div className="lp-scroll-hint" onClick={scrollToPlans}>
          ...
          <div className="lp-scroll-arrow">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="rgba(255,255,255,.6)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="lp-plans-inner">
          ...
          <div className="lp-tab-bar">
            {(
              [
                ...
                { id: 'cooperative', label: 'Cooperative / CA' },
          ...
          <div className="lp-tab-desc" key={activeTab}>
            <strong>
              ...
              {activeTab === 'cooperative' && 'CA Stores, FPOs & Cooperatives'}
            </strong>
            {' — '}{currentTab.desc}
          </div>
          ...
          <div className="lp-billing-toggle">
            <div className="lp-billing-pill">
              <span style={{ fontWeight:700,color:'#374151',fontSize:'.82rem' }}>Choose your plan :</span>
              {[
                { value: 'annual',  label: 'Annual, billed monthly' },
                ...
                <label key={opt.value}>
                  <input
                    ...
                    onChange={() => setBilling(opt.value as 'monthly' | 'annual')}
                  />
                  {opt.label}
                </label>
              ))}
